...
const Navbar = () => {
  ...
  const dropdownContent = () => {
    return (
      <div className='max-w-[1240px] m-auto p-4 border-r-4'>
  ...
  return (
    <div className='relative z-2 w-full h-[90px]'>
      <div className='max-w-[1240px] m-auto p-4' onMouseLeave={handleDropdownToggle}>
        <div className='flex justify-between items-center py-2'>
          ...
          <div className='relative sm:flex hidden' onMouseEnter={handleMouseEnter}>
            ...
            {isDropdownOpen && (
              <div className='fixed top-[90px] left-0 w-screen h-[30vh] bg-[#fff] rounded-b-2xl'>
      ...
      >
        <div className='px-2 flex gap-5 m-auto my-2'>
