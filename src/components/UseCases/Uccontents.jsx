...
const Uccontents = () => {
  return (
    <div className="w-full my-10 p-4">
      <div className="max-w-[1400px] mx-auto lg:p-8 flex-wrap lg:px-20 md:px-2 rounded-3xl bg-[#c0e6ff80] ">
          ...
          <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 ">
            <div className="md:mt-10 md:order-2 order-2 lg:order-1 p-4">
              ...
              <div className="md:w-[480px]">
                <h4 className="mb-10 font-medium text-[15px] leading-[21px] text-[#111111]">
