             ...
             <div className='w-full h-full bg-[#011829] '>
                 <div className='max-w-[1240px] mx-auto p-4'>
                    <div className='md:my-20 text-white lg:flex '>
                         <div className='mx'><p className='text-[30px] md:text-5xl lg:text-7xl font-[500] font-Inter text-white'>Build with <br/>confidence</p></div>
                         <div className='my-2 lg:ml-20 lg:pl-20 md:my-5'>
                            <p className='text-[15px] text-white'>Experience the fusion of exclusive NFT clothing packs, AR enhancements, and cryptocurrency at JooC Box. Elevate your style and maximize wardrobe profitability..</p>
